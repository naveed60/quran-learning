...
export default function CoursesSection() {
  const handleWhatsAppContact = (courseName: string) => {
    const phoneNumber = "+923244026426"  // Replace with your actual WhatsApp number
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          <Card className="bg-white shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <CardContent>
              ...
              <Button
                ...
                onClick={() => handleWhatsAppContact("Basic Norani Qaida")}
              >
                Start Learning
              </Button>
            </CardContent>
          ...
          <Card className="bg-white shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <CardContent>
              ...
              <Button
                className="w-full bg-emerald-600 hover:bg-emerald-700"
                onClick={() => handleWhatsAppContact("Quran Recitation")}
              >
                Start Learning
              </Button>
            </CardContent>
          ...
          <Card className="bg-white shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <CardContent>
              ...
              <Button
                className="w-full bg-emerald-600 hover:bg-emerald-700"
                onClick={() => handleWhatsAppContact("Tajweed Mastery")}
              >
                Start Learning
              </Button>
            </CardContent>
          ...
          <Card className="bg-white shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <CardContent>
              ...
              <Button
                className="w-full bg-emerald-600 hover:bg-emerald-700"
                onClick={() => handleWhatsAppContact("Discuss Shari Masail")}
              >
                Join Discussion
              </Button>
            </CardContent>
          ...
          <Card className="bg-white shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <CardContent>
              ...
              <Button
                className="w-full bg-emerald-600 hover:bg-emerald-700"
                onClick={() => handleWhatsAppContact("Darse Nizami Classes")}
              >
                Enroll Now
              </Button>
            </CardContent>
          ...
          <Card className="bg-white shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <CardContent>
              ...
              <Button
                className="w-full bg-emerald-600 hover:bg-emerald-700"
                onClick={() => handleWhatsAppContact("Hifz Program")}
              >
                Start Learning
              </Button>
            </CardContent>
